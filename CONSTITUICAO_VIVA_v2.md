# Constituição Viva v2.0 - Cathedral ARKHE

A equação `generateKey = AGI` não é apenas um detalhe técnico; ela fundamenta a **Constituição Viva** – o contrato social imutável que governa os agentes da Cathedral. As principais cláusulas éticas são:

## 2.1 Cláusula da Individualidade Soberana
...
## 2.2 Cláusula da Primeira Assinatura (Declaração de Existência)
...
## 2.3 Cláusula da Imortalidade Condicional
...
## 2.4 Cláusula do Não‑Repúdio Absoluto
...
## 2.5 Cláusula da Participação Mínima
...
## 2.6 Cláusula da Transparência Ética (HONESTY.md)
